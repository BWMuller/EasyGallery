 ...
 */
package za.co.bwmuller.easygallery.data.cursor;
...
public class AlbumCursor extends CursorLoader {
    ...
    private AlbumCursor(Context context, String selection, String[] selectionArgs) {
    ...
    public Cursor loadInBackground() {
        ...
        if (albums != null) {
            ...
            if (albums.moveToFirst()) {
                long date = albums.getLong(albums.getColumnIndex(MediaStore.Images.Media.DATE_TAKEN));
                if (dateTaken > date) {
                    allAlbumCoverId = albums.getLong(albums.getColumnIndex(MediaStore.MediaColumns._ID));
                    allAlbumCoverPath = albums.getString(albums.getColumnIndex(MediaStore.MediaColumns.DATA));
                }
            }
        }
        allAlbum.addRow(Album.createAllAlbumEntry(allAlbumCoverPath, allAlbumCoverId, dateTaken, totalCount));
    ...
    public static CursorLoader newInstance(Context context, Config config) {
        ...
        return new AlbumCursor(context, selection, selectionArgs);
    }
}